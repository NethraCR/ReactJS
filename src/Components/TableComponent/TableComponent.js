...
function TableComponent(props) {
    ...
    return (
        ...
        <div className='container'>
            <Button size="sm" variant="warning" id="btn1" value={'P'} onClick={filterHandler}>PENDING</Button>   
            <Button size="sm" variant="success" id="btn2" value={'A'} onClick={filterHandler}>APPROVED</Button> 
            <Button size="sm" variant="danger" id="btn3" value={'R'} onClick={filterHandler}>REJECTED</Button>
            <Button size="sm" variant="secondary" id="btn4" value={'C'} onClick={filterHandler}>CLEAR ALL</Button>  
        ...
        {props.details.length===0?"No record to display":
         searchResult.map(item=>{
            ...
            <Button variant="danger" size="sm" onClick={()=>{OnAccept(item,'Rejected')}} id="rej">REJECT</Button>
